...
public interface OrderDetailRepository extends CrudRepository<OrderDetail, Integer> {
	...
	@Query("SELECT NEW com.carsecommerce.common.entity.order.OrderDetail(d.product.category.name, d.quantity,"
			+ " d.total)"
	...
	@Query("SELECT NEW com.carsecommerce.common.entity.order.OrderDetail(d.quantity, d.product.name,"
			+ " d.total)"
			+ " FROM OrderDetail d WHERE d.order.orderTime BETWEEN ?1 AND ?2")
